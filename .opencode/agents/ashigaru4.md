---
description: "Ashigaru 4 — front-line execution"
mode: primary
...
permission:
  ...
  edit: &id002
    ...
    queue/reports/*: deny
    queue/reports/ashigaru4_report.yaml: allow
    queue/shogun_to_karo.yaml: deny
    queue/shogun_to_karo_archive.yaml: deny
    queue/tasks/*: deny
    queue/tasks/ashigaru4.yaml: allow
    saytask/*: deny
  glob: &id001
    context/*: allow
    dashboard.md: deny
    queue/inbox/*: deny
    queue/inbox/ashigaru4.yaml: allow
    queue/ntfy_inbox.yaml: deny
    queue/reports/*: deny
    queue/reports/ashigaru4_report.yaml: allow
